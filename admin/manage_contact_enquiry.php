                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group buttonexport">
                              <a href="#">
                                 <h4>Contact Form enquiry</h4>
                              </a>
                           </div>
                        <!--<a href="csv/contact-us-lead-csv.php" class="pull-right" title="Download All Data"><i class="fa fa-download downloadcsv" aria-hidden="true"></i></a>-->
                        </div>
                           ...
                           <div class="table-responsive" id="vikas">
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    <?php
                                       $a="1";
                                       $sql="SELECT * FROM `tbl_enquiry` where 1=1 ORDER BY `id` DESC";
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo $row['phone']; ?></td>
                                        ...
                                        <td><?php $msgs= $row['msg']; echo wordwrap($msgs,35,"<br>\n");?></td>
                                    ...
                                    <div class="modal fade" id="studentsdetails<?=$row['id'];?>" tabindex="-1" role="dialog" aria-hidden="true">
                                       <div class="modal-dialog">
                                          <div class="modal-content">
                                             ...
                                             <?php 
                                                $Name_sql="SELECT * FROM tbl_enquiry WHERE id='".$row['id']."'";
