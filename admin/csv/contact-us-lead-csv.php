...
?>
 <table width="3450" height="1000" border="1">
  <tr >
    ...
    <td bgcolor="#0066FF" style="color:#FFFFFF; font-size:18; font-weight:bold" height="60"  valign="top" width="200" align="center" class="font">Message</td>
	<td bgcolor="#0066FF" style="color:#FFFFFF; font-size:18; font-weight:bold" height="60"  valign="top" width="200" align="center" class="font">Lead Status</td>
...
<?php
$i=1;
	 $sql = "select * from tbl_enquiry ORDER BY id DESC";
	...
	echo"<td style='height:20px;'>".$row['msg']."</td>";
	echo"<td style='height:20px;'>".$row['lead_status']."</td>";
	echo"<td>".$row['date']."</td>";
	
	echo "</tr>";
	$i++; }
	$contents = strip_tags($contents); 
	$name=date('d-m-y').'_Contact-Us'.'-lists.xls';
